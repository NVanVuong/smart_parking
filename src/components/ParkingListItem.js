function ParkingListItem({ setShowModal, currentFilter, setCurrentFilter, parkingSite, setSelectedParkingSite }) {
        ...
        <div className="border px-6 py-3">
            <div>
                <div className="flex justify-between">
                    <div className="mb-2 w-3/5 text-lg font-semibold">{parkingSite.name}</div>
                ...
                <div className="mb-4 w-4/6 whitespace-nowrap text-sm italic text-gray-500">{parkingSite.address}</div>
